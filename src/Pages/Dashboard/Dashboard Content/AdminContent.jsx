...
const AdminContent = () => {
  return (
    <>
      ...
      <NavLink  className={({isActive}) => isActive ? 'text-white cinzel flex gap-4 items-center text-base' : `cinzel flex gap-4 items-center text-base`}><ImSpoonKnife className='text-2xl'/>Add items</NavLink>
