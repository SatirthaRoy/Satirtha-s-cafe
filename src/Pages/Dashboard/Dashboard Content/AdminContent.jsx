...
const AdminContent = () => {
  return (
    <>
      <NavLink to='/dashboard/adminhome' className={({isActive}) => isActive ? 'text-white cinzel flex gap-4 items-center text-base' : `cinzel flex gap-4 items-center text-base`}><FaHome className='text-2xl'/>Admin Home</NavLink>
      ...
      <NavLink to='/dashboard/manageitems' className={({isActive}) => isActive ? 'text-white cinzel flex gap-4 items-center text-base' : `cinzel flex gap-4 items-center text-base`}><FaListUl className='text-2xl'/>Manage Items</NavLink>
